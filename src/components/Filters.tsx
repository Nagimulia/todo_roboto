...
const FILTERS_BUTTONS = {
  [TODO_FILTERS.ALL]: { literal: 'Все', href: `/?filter=${TODO_FILTERS.ALL}` },
  [TODO_FILTERS.ACTIVE]: { literal: 'Активные', href: `/?filter=${TODO_FILTERS.ACTIVE}` },
  [TODO_FILTERS.COMPLETED]: { literal: 'Законченные', href: `/?filter=${TODO_FILTERS.COMPLETED}` }
} as const
